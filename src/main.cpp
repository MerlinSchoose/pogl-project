...
void init_textures() {
  tifo::rgb24_image *texture = tifo::load_image("image_test/texture.tga");
  tifo::rgb24_image *lighting = tifo::load_image("image_test/lighting.tga");
  tifo::rgb24_image *normalmap = tifo::load_image("image_test/normalmap.tga");
  GLuint texture_id;
  GLuint lighting_id;
  GLuint normalmap_id;
  GLint tex_location;
